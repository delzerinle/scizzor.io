const Footer = () => (
  <div className="hidden md:flex px-10 py-12 flex-wrap text-sm">
    <div className="w-1/4">
      <p className="font-medium text-primary mb-2">Explore</p>
      <ul className="font-light">
        <li className="mb-3">
          <a href="#">How Scizzor works</a>
        </li>

        <li className="mb-3">
          <a href="#">Scizzor Shop</a>
        </li>
    ...
    <div className="w-1/4">
      <p className="font-medium text-primary mb-2">Let us Help you</p>
      <ul className="font-light">
        <li className="mb-3">
    ...
    <div className="w-1/4">
      <p className="font-medium text-primary mb-2">About</p>
      <ul className="font-light">
        <li className="mb-3">
          <a href="#">Scizzor Group</a>
        </li>
    ...
    <div className="w-1/4">
      <p className="font-medium text-primary mb-2">Stay Connected</p>
      <ul className="font-light">
        <li className="mb-3">
          <a href="#">
            <span className="flex items-center">
              <svg
                className="h-5 w-5 fill-current transform scale-75 mr-2"
        ...
        <li className="mb-3">
          <a href="#">
            <span className="flex items-center">
              <svg
                className="h-5 w-6 fill-current transform scale-75 mr-2 -ml-1"
                xmlns="http://www.w3.org/2000/svg"
              >
