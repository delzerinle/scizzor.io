  ...
  return (
    <div className={wrapperClass}>
      ...
      <div className={inputWrapperClass}>
        ...
        />
        <label
          className="text-secondary font-light tracking-normal absolute py-2 px-4 left-0 transition-transform duration-200 ease-in z-0 field-input__label text-sm pt-3"
          htmlFor={name}
        >
          {label}
        </label>
