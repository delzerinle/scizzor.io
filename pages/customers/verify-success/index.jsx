...
const CustomersVerifySucess = () => (
  <>
    ...
    >
      ...
      You have been successfully verified. Click <a className="text-primary" href="/customers/sign-in">here</a> to sign in to your account.
      </p>
    </Auth>
  </>
);

export default CustomersVerifySucess;
